...
-- Initial test user (plain text password: admin123)
INSERT INTO users (username, password, email, role) VALUES
('admin', 'admin123', 'admin@moricakes.com', 'admin');

-- Initial test user (plain text password: user123)
INSERT INTO users (username, password, email) VALUES
('user', 'user123', 'user@moricakes.com');
...
INSERT INTO menu_items (name, category_id, price, description, image_url, rating, review_count, is_available) VALUES
-- Cheese Cakes
...
('Baked Cheesecake', 1, 42.90, 'Rich baked cheesecake with a smooth texture and caramelized top', 'https://p11-doubao-search-sign.byteimg.com/tos-cn-i-be4g95zd3a/2313347519743393804~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060523&x-signature=z5BKb%2FVflTPJG6njr2ekEUrWmPE%3D', 4.7, 142, TRUE),

-- Strawberry Cakes
('Strawberry Shortcake', 2, 36.90, 'Light sponge cake layered with fresh strawberries and whipped cream', 'https://p11-doubao-search-sign.byteimg.com/labis/dcb052c92380d41db963e4f27f84de61~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060523&x-signature=WwEi93itH3uE0%2BFewQcC3zRrFKE%3D', 4.9, 178, TRUE),
('Strawberry Square Cake', 2, 38.90, 'Square-shaped strawberry cake with layers of fresh strawberries and vanilla cream', 'https://p11-doubao-search-sign.byteimg.com/labis/da55c109bb9847ec513b8e32f22edf35~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060523&x-signature=uligxdhjRy9uo%2FuYrC9cR%2Bb2uqg%3D', 4.8, 165, TRUE),

-- Chocolate Cakes
('Chocolate Indulgence Cake', 3, 45.90, 'Rich chocolate cake with chocolate ganache frosting and decorative chocolate roses', 'https://p26-doubao-search-sign.byteimg.com/tos-cn-i-xv4ileqgde/b65e08dc939d4298a831a002b6bfd950~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060523&x-signature=pBEqzjTA%2Fu9fhOh7SjtWqOva45g%3D', 4.9, 203, TRUE),
('Chocolate Truffle Cake', 3, 48.90, 'Decadent chocolate truffle cake with a smooth, velvety texture', 'https://p3-doubao-search-sign.byteimg.com/labis/a6ab8a2f2d0ff3912003c08a9d78ac73~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060523&x-signature=pcyJ4hCLgA0oq1%2Fk03pllCt8BZU%3D', 4.9, 189, TRUE),

-- Matcha Cakes
('Matcha Green Tea Cake', 4, 41.90, 'Japanese matcha cake with fresh strawberries and sweet red bean paste filling', 'https://p3-doubao-search-sign.byteimg.com/labis/cfaa9222aafd352ce37390291b06012f~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060534&x-signature=DqWywH4uo2Z03tUa9irJuHnWY9I%3D', 4.5, 123, TRUE),
('Matcha Mousse Cake', 4, 43.90, 'Light and fluffy matcha mousse cake with a smooth green tea flavor', 'https://p11-doubao-search-sign.byteimg.com/labis/7e19951608c2a4c763aff2e6e52a64fb~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060534&x-signature=jRqSBOCreruYKKa8UM%2BreVYI8%2FE%3D', 4.6, 135, TRUE),

-- Coffee Cakes
('Coffee Layer Cake', 5, 39.90, 'Rich coffee cake with layers of coffee-infused buttercream and chocolate ganache', 'https://p26-doubao-search-sign.byteimg.com/tos-cn-i-be4g95zd3a/1024821038558740503~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060534&x-signature=EKFyqmaKetNKuxH0OXEIiJV1rZY%3D', 4.7, 148, TRUE),
('Hazelnut Coffee Cake', 5, 42.90, 'Delicious coffee cake with hazelnuts and cranberries, drizzled with vanilla glaze', 'https://p3-doubao-search-sign.byteimg.com/tos-cn-i-be4g95zd3a/1018781790562025500~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32&x-expires=1784060534&x-signature=PepHoZADYB8hT%2FssVQe%2Fjy1B5Qc%3D', 4.8, 156, TRUE),
